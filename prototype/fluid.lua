data:extend(
        {
            ...
            },
            {
                ...
                max_temperature = 100,
                icon = "__Darkstar_utilities_fixed__/graphics/icons/norbornadiene.png",
                icon_size = 32,
                pressure_to_speed_ratio = 0.4,
                flow_to_energy_ratio = 0.59,
                order = "a[fluid]-b[crude-oil]"
            },
            {
                ...
                max_temperature = 100,
                icon = "__Darkstar_utilities_fixed__/graphics/icons/acetylene.png",
                icon_size = 32,
                pressure_to_speed_ratio = 0.4,
                flow_to_energy_ratio = 0.59,
                order = "a[fluid]-b[crude-oil]"
            },
            {
                ...
                max_temperature = 100,
                icon = "__Darkstar_utilities_fixed__/graphics/icons/argon.png",
                icon_size = 32,
                pressure_to_speed_ratio = 0.4,
                flow_to_energy_ratio = 0.59,
                order = "z1"
            ...
            },
            {
                ...
                max_temperature = 100,
                icon = "__Darkstar_utilities_fixed__/graphics/icons/lox.png",
                icon_size = 32,
                pressure_to_speed_ratio = 0.4,
                flow_to_energy_ratio = 0.59,
                order = "z3"
            },
            {
                ...
                max_temperature = 100,
                icon = "__Darkstar_utilities_fixed__/graphics/icons/cyclopentadiene.png",
                icon_size = 32,
                pressure_to_speed_ratio = 0.4,
                flow_to_energy_ratio = 0.59,
                order = "a[fluid]-b[crude-oil]"
            ...
            },
            {
                ...
                icon = "__Darkstar_utilities_fixed__/graphics/icons/quantum-waste.png",
                icon_size = 32,
                pressure_to_speed_ratio = 0.4,
                flow_to_energy_ratio = 0.59,
                order = "a[fluid]-b[crude-oil]"
