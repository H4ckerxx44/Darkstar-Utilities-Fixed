        ...
        {
            {
                ...
                mineable = { hardness = 0.2, mining_time = 0.5, result = "stone-path-black" },
            ...
            },
            {
                ...
                needs_correction = false,
                mineable = { hardness = 0.2, mining_time = 0.5, result = "stone-path-blue" },
                mined_sound = { filename = "__base__/sound/deconstruct-bricks.ogg" },
                collision_mask = { "ground-tile" },
                walking_speed_modifier = 1.3,
                layer = 81,
            ...
            },
            {
                ...
                needs_correction = false,
                mineable = { hardness = 0.2, mining_time = 0.5, result = "stone-path-green" },
                mined_sound = { filename = "__base__/sound/deconstruct-bricks.ogg" },
                collision_mask = { "ground-tile" },
                walking_speed_modifier = 1.3,
                layer = 82,
            ...
            },
            {
                ...
                needs_correction = false,
                mineable = { hardness = 0.2, mining_time = 0.5, result = "stone-path-purple" },
                mined_sound = { filename = "__base__/sound/deconstruct-bricks.ogg" },
                collision_mask = { "ground-tile" },
                walking_speed_modifier = 1.3,
                layer = 83,
            ...
            },
            {
                ...
                name = "stone-path-red",
                needs_correction = false,
                mineable = { hardness = 0.2, mining_time = 0.5, result = "stone-path-red" },
                mined_sound = { filename = "__base__/sound/deconstruct-bricks.ogg" },
                collision_mask = { "ground-tile" },
                walking_speed_modifier = 1.3,
                layer = 84,
            ...
            },
            {
                ...
                needs_correction = false,
                mineable = { hardness = 0.2, mining_time = 0.5, result = "stone-path-yellow" },
                mined_sound = { filename = "__base__/sound/deconstruct-bricks.ogg" },
                collision_mask = { "ground-tile" },
                walking_speed_modifier = 1.3,
                layer = 85,
...

            {
                ...
                name = "express-tile",
                needs_correction = false,
                mineable = { hardness = 0.2, mining_time = 0.5, result = "express-tile" },
                mined_sound = { filename = "__base__/sound/deconstruct-bricks.ogg" },
                collision_mask = { "ground-tile" },
            ...
            },
            {
                ...
                name = "glass-tile",
                needs_correction = false,
                mineable = { hardness = 0.2, mining_time = 0.5, result = "glass-tile" },
                mined_sound = { filename = "__base__/sound/deconstruct-bricks.ogg" },
                collision_mask = { "ground-tile" },
