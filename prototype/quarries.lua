...
ent.icon_size = 32
ent.picture = {
    filename = "__Darkstar_utilities_fixed__/graphics/entity/quarry.png",
    width = 818,
    height = 678,
    shift = { 0, 0 }
}
...
ent.icon_size = 32
ent.picture = {
    filename = "__Darkstar_utilities_fixed__/graphics/entity/quarry2.png",
    width = 1638,
    height = 1414,
...
ent.picture = {
    filename = "__Darkstar_utilities_fixed__/graphics/entity/space-quarry.png",
    width = 237,
    height = 210,
    shift = { 11, 11 }
}
...
ent.icon_size = 32
ent.picture = {
    filename = "__Darkstar_utilities_fixed__/graphics/entity/space-quarry-2.png",
    width = 818,
    height = 678,
    shift = { 0, 0 }
}
